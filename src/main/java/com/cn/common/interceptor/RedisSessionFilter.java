 ...
 */
public class RedisSessionFilter  extends DelegatingFilterProxy {
	 ...
	 */
	public RedisSessionFilter(Filter delegate) {
	 ...
	 * @see #setEnvironment(org.springframework.core.env.Environment)
	 */
	public RedisSessionFilter(String targetBeanName) {
	 ...
	 * @see #setEnvironment(org.springframework.core.env.Environment)
	 */
	public RedisSessionFilter(String targetBeanName, WebApplicationContext wac) {
...
//		String noMapperUrl = getFilterConfig().getInitParameter("noMapperUrl");
//		HttpServletRequest req=(HttpServletRequest)request;
//		if(null!=noMapperUrl){
//			String[] urls=noMapperUrl.split(";");
//			for (int i = 0; i < urls.length; i++) {
//				if(urls[i]==null||urls[i].equals(""))continue;
//				if(req.getRequestURI().indexOf(urls[i])!=-1){
//					invokeDelegate(delegateToUse, req, response, filterChain);
//				}
//			}
//		}
